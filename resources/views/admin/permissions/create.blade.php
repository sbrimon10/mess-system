<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <h2 class="text-xl font-semibold mb-4">Permission Creation</h2>
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <x-text-input id="guard_name" class="block mt-1 w-full" type="text" name="guard_name" :value="old('guard_name')"  autocomplete="off" />
